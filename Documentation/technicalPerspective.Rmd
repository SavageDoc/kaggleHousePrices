...
A support vector machine (SVM) model has been created to predict house prices. It results in a reduction of `r scales::percent( (0.4089 - 0.11879)/0.4089 )` in the error of predicting house prices.
...
Having built a model, it is used to generate predictions for the training and test sets. The test set was then uploaded to be scored on the public leaderboard.
...
The maximum absolute difference between the sample submission and my reproduction is on the order of $10^{-10}$. This is sufficiently close that I've concluded that the model has been reproduced. 
